...
---
## a. 주제설명 및 간단한 도식
간단한 자동차 경주(Racing Car)시뮬레이션을 구현하는 프로젝트다.
이 프로젝트는 크게 세 단계(입출력 구현 → 1회 전진 시뮬레이션 → n회 전진 시뮬레이션)의 과정으로 진행할 예정이다.
...
| 클래스명               | 주요 역할          | 세부 기능                                                              | 비고                         |        
| ------------------ | -------------- | ------------------------------------------------------------------ | -------------------------- |
| **class명 작성**     | 주요역할 작성 |                세부기능 작성                   | 비고 작성             |        
...
## d. 문제 요구사항
### 과제 진행 요구 사항
- [ ] 미션은 [자동차 경주 저장소](https://github.com/woowacourse-precourse/java-racingcar-8)를 포크하고 클론하는 것으로 시작한다.  
